...
public class W1D4Pair {
	...
	public static class MyPartitioner extends Partitioner<Pair<String, Long>> {
		...
		@Override
		public int getPartition(Pair<String, Long> key) {
			return Math.abs(key.getLeft().hashCode()) % numReducer;
		}
	...
	public static class MyMapper extends Mapper<Long, String, String, Pair<Long, Long>> {
		...
		Map<String, Pair<Long, Long>> m = new HashMap<>();
